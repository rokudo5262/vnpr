 ...
 *
 */
class NxPro_Google_Service_Resource
{
  ...
  /** @var NxPro_Google_Client $client */
  private $client;
   ...
   * @return NxPro_Google_Http_Request|expectedClass
  ...
  public function call($name, $arguments, $expectedClass = null)
  {
    if (! isset($this->methods[$name])) {
      ...
      throw new NxPro_Google_Exception(
          "Unknown function: " .
    ...
    if (isset($parameters['postBody'])) {
      if ($parameters['postBody'] instanceof NxPro_Google_Model) {
    ...
    foreach ($parameters as $key => $val) {
      if ($key != 'postBody' && ! isset($method['parameters'][$key])) {
        ...
        throw new NxPro_Google_Exception("($name) unknown parameter: '$key'");
      }
    }
    ...
    foreach ($method['parameters'] as $paramName => $paramSpec) {
      if (isset($paramSpec['required']) &&
        ...
        throw new NxPro_Google_Exception("($name) missing required param: '$paramName'");
      }
    ...
    if (isset($parameters['data'])) {
      ...
      $upload = new NxPro_Google_Http_MediaFileUpload($this->client, $request, $mimeType, $data);
  ...
  public function createRequestUri($restPath, $params)
  {
    ...
    if (count($uriTemplateVars)) {
      $uriTemplateParser = new NxPro_Google_Utils_UriTemplate();
