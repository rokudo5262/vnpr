 ...
 */
class NxPro_Google_Task_Runner
{
   ...
   * @throws NxPro_Google_Task_Exception when misconfigured
   */
  public function __construct(
    ...
    if (isset($config['initial_delay'])) {
      if ($config['initial_delay'] < 0) {
        throw new NxPro_Google_Task_Exception(
   ...
   *
   * @return mixed
   * @throws NxPro_Google_Task_Retryable on failure when no retries are available.
   */
  public function run()
  {
    while ($this->attempt()) {
      ...
      } catch (NxPro_Google_Service_Exception $exception) {
