...
class NxPro_Google_Http_REST
{
   ...
   * @throws NxPro_Google_Service_Exception on server side error (ie: not authenticated,
  ...
  public static function execute(
    ...
    $runner = new NxPro_Google_Task_Runner(
        $config,
   ...
   * @static
   * @throws NxPro_Google_Service_Exception
  ...
  public static function decodeHttpResponse(
    ...
    if (intVal($code) >= 400) {
      ...
      throw new NxPro_Google_Service_Exception($body, $code, null, self::getResponseErrors($body));
    }
