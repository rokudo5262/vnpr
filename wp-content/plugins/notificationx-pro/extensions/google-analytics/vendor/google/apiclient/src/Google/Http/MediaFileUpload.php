 ...
 * of sizable data.
 */
class NxPro_Google_Http_MediaFileUpload
{
  ...
  *
  * @param NxPro_Google_Http_Request $httpRequest the Reuqest which will be send
  *
  ...
  */
  private function makePutRequest(RequestInterface $request)
  {
    ...
    return NxPro_Google_Http_REST::decodeHttpResponse($response, $this->request);
  }
  ...
  private function fetchResumeUri()
  {
    ...
    throw new NxPro_Google_Exception($error);
  }
