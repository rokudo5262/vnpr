...
class NxPro_Google_Client
{
  ...
  public function __construct(array $config = array())
  {
    $this->config = array_merge(
        [
          ...
          // Service class used in NxPro_Google_Client::verifyIdToken.
  ...
  public function fetchAccessTokenWithAssertion(ClientInterface $authHttp = null)
  {
    if (!$this->isUsingApplicationDefaultCredentials()) {
      throw new DomainException(
          ...
          . ' NxPro_Google_Client::setAuthConfig or set the path to your JSON file'
          . ' with the "GOOGLE_APPLICATION_CREDENTIALS" environment variable'
          . ' and call NxPro_Google_Client::useApplicationDefaultCredentials to'
  ...
  {
    $tokenRevoker = new NxPro_Google_AccessToken_Revoke(
        $this->getHttpClient()
    );
  ...
  {
    $tokenVerifier = new NxPro_Google_AccessToken_Verify(
        $this->getHttpClient(),
        $this->getCache(),
        $this->config['jwt']
    );
   ...
   *
   * @param $request Psr\Http\Message\RequestInterface|NxPro_Google_Http_Batch
   * @throws NxPro_Google_Exception
  ...
  public function execute(RequestInterface $request, $expectedClass = null)
  {
    ...
    return NxPro_Google_Http_REST::execute(
        $http,
        $request,
        $expectedClass,
        $this->config['retry'],
  ...
  protected function getAuthHandler()
  {
    ...
    return NxPro_Google_AuthHandler_AuthHandlerFactory::build(
        $this->getCache(),
