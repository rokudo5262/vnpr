 ...
 *
 */
class NxPro_Google_Model implements ArrayAccess
{
  /**
   * If you need to specify a NULL JSON value, use NxPro_Google_Model::NULL_VALUE
  ...
  {
    if ($value instanceof NxPro_Google_Model) {
   ...
   * @throws NxPro_Google_Exception Thrown if $obj isn't an array.
