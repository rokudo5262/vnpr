 ...
 *  </code>
 */
class NxPro_Google_Service_Analytics_Resource_DataGa extends NxPro_Google_Service_Resource
{
  /**
   ...
   * @return NxPro_Google_Service_Analytics_GaData
   */
  public function get($ids, $startDate, $endDate, $metrics, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "NxPro_Google_Service_Analytics_GaData");
  }
}
