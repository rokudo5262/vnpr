 ...
 *  </code>
 */
class NxPro_Google_Service_Analytics_Resource_DataRealtime extends NxPro_Google_Service_Resource
{
  /**
   ...
   * @return NxPro_Google_Service_Analytics_RealtimeData
   */
  public function get($ids, $metrics, $optParams = array())
  {
    $params = array('ids' => $ids, 'metrics' => $metrics);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "NxPro_Google_Service_Analytics_RealtimeData");
  }
}
