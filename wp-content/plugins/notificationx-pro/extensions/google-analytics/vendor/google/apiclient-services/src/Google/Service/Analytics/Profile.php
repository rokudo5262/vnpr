...
class NxPro_Google_Service_Analytics_Profile extends NxPro_Google_Model
{
  public $accountId;
  public $botFilteringEnabled;
  protected $childLinkType = 'NxPro_Google_Service_Analytics_ProfileChildLink';
  ...
  public $kind;
  public $name;
  protected $parentLinkType = 'NxPro_Google_Service_Analytics_ProfileParentLink';
  protected $parentLinkDataType = '';
  protected $permissionsType = 'NxPro_Google_Service_Analytics_ProfilePermissions';
  ...
  /**
   * @param NxPro_Google_Service_Analytics_ProfileChildLink
   */
  public function setChildLink(NxPro_Google_Service_Analytics_ProfileChildLink $childLink)
  {
    $this->childLink = $childLink;
  }
  /**
   * @return NxPro_Google_Service_Analytics_ProfileChildLink
   */
  ...
  /**
   * @param NxPro_Google_Service_Analytics_ProfileParentLink
   */
  public function setParentLink(NxPro_Google_Service_Analytics_ProfileParentLink $parentLink)
  {
    $this->parentLink = $parentLink;
  }
  /**
   * @return NxPro_Google_Service_Analytics_ProfileParentLink
   */
  ...
  /**
   * @param NxPro_Google_Service_Analytics_ProfilePermissions
   */
  public function setPermissions(NxPro_Google_Service_Analytics_ProfilePermissions $permissions)
  {
    $this->permissions = $permissions;
  }
  /**
   * @return NxPro_Google_Service_Analytics_ProfilePermissions
   */
