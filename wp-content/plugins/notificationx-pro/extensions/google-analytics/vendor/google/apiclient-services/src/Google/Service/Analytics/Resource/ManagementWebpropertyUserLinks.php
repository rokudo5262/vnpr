 ...
 *  </code>
 */
class NxPro_Google_Service_Analytics_Resource_ManagementWebpropertyUserLinks extends NxPro_Google_Service_Resource
{
  /**
   ...
   */
  public function insert($accountId, $webPropertyId, NxPro_Google_Service_Analytics_EntityUserLink $postBody, $optParams = array())
  {
   ...
   * @return NxPro_Google_Service_Analytics_EntityUserLink
   */
  public function update($accountId, $webPropertyId, $linkId, NxPro_Google_Service_Analytics_EntityUserLink $postBody, $optParams = array())
  {
