...
class NxPro_Google_Service_AnalyticsReporting_ReportRequest extends NxPro_Google_Collection
{
  protected $collection_key = 'segments';
  protected $cohortGroupType = 'NxPro_Google_Service_AnalyticsReporting_CohortGroup';
  protected $cohortGroupDataType = '';
  protected $dateRangesType = 'NxPro_Google_Service_AnalyticsReporting_DateRange';
  ...
  protected $metricFilterClausesType = 'NxPro_Google_Service_AnalyticsReporting_MetricFilterClause';
  protected $metricFilterClausesDataType = 'array';
  protected $metricsType = 'NxPro_Google_Service_AnalyticsReporting_Metric';
  protected $metricsDataType = 'array';
  protected $orderBysType = 'NxPro_Google_Service_AnalyticsReporting_OrderBy';
  protected $orderBysDataType = 'array';
  public $pageSize;
  public $pageToken;
  protected $pivotsType = 'NxPro_Google_Service_AnalyticsReporting_Pivot';
  protected $pivotsDataType = 'array';
  public $samplingLevel;
  protected $segmentsType = 'NxPro_Google_Service_AnalyticsReporting_Segment';
  protected $segmentsDataType = 'array';
  public $viewId;

  /**
   * @param NxPro_Google_Service_AnalyticsReporting_CohortGroup
   */
  public function setCohortGroup(NxPro_Google_Service_AnalyticsReporting_CohortGroup $cohortGroup)
  {
    $this->cohortGroup = $cohortGroup;
  }
  /**
   * @return NxPro_Google_Service_AnalyticsReporting_CohortGroup
   */
  ...
  /**
   * @param NxPro_Google_Service_AnalyticsReporting_DateRange
   */
  ...
  /**
   * @return NxPro_Google_Service_AnalyticsReporting_DateRange
   */
  ...
  /**
   * @param NxPro_Google_Service_AnalyticsReporting_MetricFilterClause
   */
  ...
  /**
   * @return NxPro_Google_Service_AnalyticsReporting_MetricFilterClause
   */
  ...
  /**
   * @param NxPro_Google_Service_AnalyticsReporting_OrderBy
   */
  ...
  /**
   * @return NxPro_Google_Service_AnalyticsReporting_OrderBy
   */
  ...
  /**
   * @param NxPro_Google_Service_AnalyticsReporting_Pivot
   */
  ...
  /**
   * @return NxPro_Google_Service_AnalyticsReporting_Pivot
   */
  ...
  /**
   * @param NxPro_Google_Service_AnalyticsReporting_Segment
   */
  ...
  /**
   * @return NxPro_Google_Service_AnalyticsReporting_Segment
   */
