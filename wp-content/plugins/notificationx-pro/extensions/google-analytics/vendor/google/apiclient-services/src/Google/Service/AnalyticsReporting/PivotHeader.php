...
class NxPro_Google_Service_AnalyticsReporting_PivotHeader extends NxPro_Google_Collection
{
  protected $collection_key = 'pivotHeaderEntries';
  protected $pivotHeaderEntriesType = 'NxPro_Google_Service_AnalyticsReporting_PivotHeaderEntry';
  protected $pivotHeaderEntriesDataType = 'array';
  public $totalPivotGroupsCount;

  /**
   * @param NxPro_Google_Service_AnalyticsReporting_PivotHeaderEntry
   */
  ...
  /**
   * @return NxPro_Google_Service_AnalyticsReporting_PivotHeaderEntry
   */
