 ...
 *  </code>
 */
class NxPro_Google_Service_Analytics_Resource_ManagementCustomMetrics extends NxPro_Google_Service_Resource
{
  /**
   ...
   * @return NxPro_Google_Service_Analytics_CustomMetric
   */
  public function get($accountId, $webPropertyId, $customMetricId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "NxPro_Google_Service_Analytics_CustomMetric");
  }
  /**
   ...
   * create.
   * @param NxPro_Google_Service_Analytics_CustomMetric $postBody
   * @param array $optParams Optional parameters.
   * @return NxPro_Google_Service_Analytics_CustomMetric
   */
  public function insert($accountId, $webPropertyId, NxPro_Google_Service_Analytics_CustomMetric $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "NxPro_Google_Service_Analytics_CustomMetric");
  }
  /**
   ...
   * @return NxPro_Google_Service_Analytics_CustomMetrics
   */
  public function listManagementCustomMetrics($accountId, $webPropertyId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "NxPro_Google_Service_Analytics_CustomMetrics");
  }
  /**
   ...
   * @return NxPro_Google_Service_Analytics_CustomMetric
   */
  public function patch($accountId, $webPropertyId, $customMetricId, NxPro_Google_Service_Analytics_CustomMetric $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customMetricId' => $customMetricId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "NxPro_Google_Service_Analytics_CustomMetric");
  }
  /**
   ...
   * @return NxPro_Google_Service_Analytics_CustomMetric
   */
  public function update($accountId, $webPropertyId, $customMetricId, NxPro_Google_Service_Analytics_CustomMetric $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customMetricId' => $customMetricId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "NxPro_Google_Service_Analytics_CustomMetric");
  }
}
