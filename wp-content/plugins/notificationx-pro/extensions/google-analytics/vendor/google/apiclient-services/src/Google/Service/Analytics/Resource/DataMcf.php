 ...
 *  </code>
 */
class NxPro_Google_Service_Analytics_Resource_DataMcf extends NxPro_Google_Service_Resource
{
  /**
   ...
   * @return NxPro_Google_Service_Analytics_McfData
   */
  public function get($ids, $startDate, $endDate, $metrics, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "NxPro_Google_Service_Analytics_McfData");
  }
}
