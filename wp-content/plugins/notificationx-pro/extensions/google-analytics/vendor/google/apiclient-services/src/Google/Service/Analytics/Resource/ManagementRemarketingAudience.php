 ...
 * Typical usage is:
 *  <code>
 *   $analyticsService = new NxPro_Google_Service_Analytics(...);
 *   $remarketingAudience = $analyticsService->remarketingAudience;
 *  </code>
 */
class NxPro_Google_Service_Analytics_Resource_ManagementRemarketingAudience extends NxPro_Google_Service_Resource
{
  /**
   ...
   * retrieve.
   * @param array $optParams Optional parameters.
   * @return NxPro_Google_Service_Analytics_RemarketingAudience
   */
  public function get($accountId, $webPropertyId, $remarketingAudienceId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'remarketingAudienceId' => $remarketingAudienceId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "NxPro_Google_Service_Analytics_RemarketingAudience");
  }
  /**
   ...
   * @param NxPro_Google_Service_Analytics_RemarketingAudience $postBody
   * @param array $optParams Optional parameters.
   * @return NxPro_Google_Service_Analytics_RemarketingAudience
   */
  public function insert($accountId, $webPropertyId, NxPro_Google_Service_Analytics_RemarketingAudience $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "NxPro_Google_Service_Analytics_RemarketingAudience");
  }
  /**
   ...
   * @return NxPro_Google_Service_Analytics_RemarketingAudiences
   */
  public function listManagementRemarketingAudience($accountId, $webPropertyId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "NxPro_Google_Service_Analytics_RemarketingAudiences");
  }
  /**
   ...
   * @return NxPro_Google_Service_Analytics_RemarketingAudience
   */
  public function patch($accountId, $webPropertyId, $remarketingAudienceId, NxPro_Google_Service_Analytics_RemarketingAudience $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "NxPro_Google_Service_Analytics_RemarketingAudience");
  }
  /**
   ...
   * @return NxPro_Google_Service_Analytics_RemarketingAudience
   */
  public function update($accountId, $webPropertyId, $remarketingAudienceId, NxPro_Google_Service_Analytics_RemarketingAudience $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'remarketingAudienceId' => $remarketingAudienceId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "NxPro_Google_Service_Analytics_RemarketingAudience");
  }
}
