 ...
 *  </code>
 */
class NxPro_Google_Service_Analytics_Resource_ManagementAccountSummaries extends NxPro_Google_Service_Resource
{
  /**
   ...
   * @return NxPro_Google_Service_Analytics_AccountSummaries
   */
  public function listManagementAccountSummaries($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "NxPro_Google_Service_Analytics_AccountSummaries");
  }
}
