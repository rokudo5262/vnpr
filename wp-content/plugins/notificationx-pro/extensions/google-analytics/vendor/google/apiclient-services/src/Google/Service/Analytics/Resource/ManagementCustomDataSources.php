 ...
 *  </code>
 */
class NxPro_Google_Service_Analytics_Resource_ManagementCustomDataSources extends NxPro_Google_Service_Resource
{
  /**
   ...
   * results parameter.
   * @return NxPro_Google_Service_Analytics_CustomDataSources
   */
  public function listManagementCustomDataSources($accountId, $webPropertyId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "NxPro_Google_Service_Analytics_CustomDataSources");
  }
}
