 ...
 *  </code>
 */
class NxPro_Google_Service_Analytics_Resource_ManagementCustomDimensions extends NxPro_Google_Service_Resource
{
  /**
   ...
   * @return NxPro_Google_Service_Analytics_CustomDimension
   */
  public function get($accountId, $webPropertyId, $customDimensionId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "NxPro_Google_Service_Analytics_CustomDimension");
  }
  /**
   ...
   * @param string $webPropertyId Web property ID for the custom dimension to
   * create.
   * @param NxPro_Google_Service_Analytics_CustomDimension $postBody
   * @param array $optParams Optional parameters.
   * @return NxPro_Google_Service_Analytics_CustomDimension
   */
  public function insert($accountId, $webPropertyId, NxPro_Google_Service_Analytics_CustomDimension $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "NxPro_Google_Service_Analytics_CustomDimension");
  }
  /**
   ...
   * @return NxPro_Google_Service_Analytics_CustomDimensions
   */
  public function listManagementCustomDimensions($accountId, $webPropertyId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "NxPro_Google_Service_Analytics_CustomDimensions");
  }
  /**
   ...
   * @return NxPro_Google_Service_Analytics_CustomDimension
   */
  public function patch($accountId, $webPropertyId, $customDimensionId, NxPro_Google_Service_Analytics_CustomDimension $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customDimensionId' => $customDimensionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "NxPro_Google_Service_Analytics_CustomDimension");
  }
  /**
   ...
   * @return NxPro_Google_Service_Analytics_CustomDimension
   */
  public function update($accountId, $webPropertyId, $customDimensionId, NxPro_Google_Service_Analytics_CustomDimension $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customDimensionId' => $customDimensionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "NxPro_Google_Service_Analytics_CustomDimension");
  }
}
