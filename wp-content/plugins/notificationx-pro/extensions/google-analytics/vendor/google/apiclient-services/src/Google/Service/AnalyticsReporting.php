 ...
 * @author Google, Inc.
 */
class NxPro_Google_Service_AnalyticsReporting extends NxPro_Google_Service
{
  ...
  public function __construct(NxPro_Google_Client $client, $rootUrl = null)
  {
    ...
    $this->reports = new NxPro_Google_Service_AnalyticsReporting_Resource_Reports(
        $this,
        $this->serviceName,
        'reports',
        array(
    ...
    $this->userActivity = new NxPro_Google_Service_AnalyticsReporting_Resource_UserActivity(
        $this,
        $this->serviceName,
        'userActivity',
        array(
