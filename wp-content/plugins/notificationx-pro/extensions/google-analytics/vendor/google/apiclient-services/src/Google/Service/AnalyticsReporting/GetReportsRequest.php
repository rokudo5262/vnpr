...
class NxPro_Google_Service_AnalyticsReporting_GetReportsRequest extends NxPro_Google_Collection
{
  protected $collection_key = 'reportRequests';
  protected $reportRequestsType = 'NxPro_Google_Service_AnalyticsReporting_ReportRequest';
  protected $reportRequestsDataType = 'array';
  public $useResourceQuotas;

  /**
   * @param NxPro_Google_Service_AnalyticsReporting_ReportRequest
   */
  ...
  /**
   * @return NxPro_Google_Service_AnalyticsReporting_ReportRequest
   */
