...
class NxPro_Google_Service_Analytics_Experiment extends NxPro_Google_Collection
{
  ...
  protected $parentLinkType = 'NxPro_Google_Service_Analytics_ExperimentParentLink';
  ...
  public $updated;
  protected $variationsType = 'NxPro_Google_Service_Analytics_ExperimentVariations';
  ...
  /**
   * @param NxPro_Google_Service_Analytics_ExperimentParentLink
   */
  public function setParentLink(NxPro_Google_Service_Analytics_ExperimentParentLink $parentLink)
  {
    $this->parentLink = $parentLink;
  }
  /**
   * @return NxPro_Google_Service_Analytics_ExperimentParentLink
   */
  ...
  /**
   * @param NxPro_Google_Service_Analytics_ExperimentVariations
   */
  ...
  /**
   * @return NxPro_Google_Service_Analytics_ExperimentVariations
   */
