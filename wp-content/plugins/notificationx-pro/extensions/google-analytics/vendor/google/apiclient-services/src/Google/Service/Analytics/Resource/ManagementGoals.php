 ...
 *  </code>
 */
class NxPro_Google_Service_Analytics_Resource_ManagementGoals extends NxPro_Google_Service_Resource
{
  /**
   ...
   * @return NxPro_Google_Service_Analytics_Goal
   */
  public function get($accountId, $webPropertyId, $profileId, $goalId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "NxPro_Google_Service_Analytics_Goal");
  }
  /**
   ...
   * @param NxPro_Google_Service_Analytics_Goal $postBody
   * @param array $optParams Optional parameters.
   * @return NxPro_Google_Service_Analytics_Goal
   */
  public function insert($accountId, $webPropertyId, $profileId, NxPro_Google_Service_Analytics_Goal $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "NxPro_Google_Service_Analytics_Goal");
  }
  /**
   ...
   * @return NxPro_Google_Service_Analytics_Goals
   */
  public function listManagementGoals($accountId, $webPropertyId, $profileId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "NxPro_Google_Service_Analytics_Goals");
  }
  /**
   ...
   * @return NxPro_Google_Service_Analytics_Goal
   */
  public function patch($accountId, $webPropertyId, $profileId, $goalId, NxPro_Google_Service_Analytics_Goal $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'goalId' => $goalId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "NxPro_Google_Service_Analytics_Goal");
  }
  /**
   ...
   * @return NxPro_Google_Service_Analytics_Goal
   */
  public function update($accountId, $webPropertyId, $profileId, $goalId, NxPro_Google_Service_Analytics_Goal $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'goalId' => $goalId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "NxPro_Google_Service_Analytics_Goal");
  }
}
