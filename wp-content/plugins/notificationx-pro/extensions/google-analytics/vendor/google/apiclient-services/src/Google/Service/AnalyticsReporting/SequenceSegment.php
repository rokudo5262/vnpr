...
class NxPro_Google_Service_AnalyticsReporting_SequenceSegment extends NxPro_Google_Collection
{
  protected $collection_key = 'segmentSequenceSteps';
  public $firstStepShouldMatchFirstHit;
  protected $segmentSequenceStepsType = 'NxPro_Google_Service_AnalyticsReporting_SegmentSequenceStep';
  ...
  /**
   * @param NxPro_Google_Service_AnalyticsReporting_SegmentSequenceStep
   */
  ...
  /**
   * @return NxPro_Google_Service_AnalyticsReporting_SegmentSequenceStep
   */
