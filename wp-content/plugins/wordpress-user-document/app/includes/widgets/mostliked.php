...
class WUD_Mostliked_Widget extends WP_Widget {
	/**
	 * WUD_Mostliked_Widget constructor.
	 */
	public function __construct() {
		$widget_ops = array(
			'description'                 => esc_html__( 'Display Most Liked Documents', 'wud' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'wud_mostliked_documents_widget', esc_html__( 'WUD - Most Liked Documents', 'wud' ), $widget_ops );
	}
	...
	public function form( $instance ) {
		...
		$instance = wp_parse_args( $instance,
			array(
				'title'       => esc_attr__( 'Most Liked Documents', 'wud' ),
				'category_id' => '',
				'limit'       => 5,
			)
		);
        ...
        <p>
            ...
            <br/>
            <small><?php esc_html_e( 'Number of most liked documents.', 'wud' ); ?></small>
        </p>
	...
	public function widget( $args, $instance ) {
		...
		$docs       = $docs_model->get_most_liked_documents( $category_id, $limit );
		...
		?>
		<?php
		include wud_get_template( 'widgets/mostliked', false, false );
		?>
		<?php
