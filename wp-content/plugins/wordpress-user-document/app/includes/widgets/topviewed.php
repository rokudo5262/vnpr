...
/**
 * Class WUD_Topviewed_Widget
 */
class WUD_Topviewed_Widget extends WP_Widget {
	/**
	 * WUD_Topviewed_Widget constructor.
	 */
	public function __construct() {
		$widget_ops = array(
			'description'                 => esc_html__( 'Display Top Viewed Documents', 'wud' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'wud_topviewed_documents_widget', esc_html__( 'WUD - Top Viewed Documents', 'wud' ), $widget_ops );
	}
	...
	public function form( $instance ) {
		...
		$instance = wp_parse_args( $instance,
			array(
				'title'       => esc_attr__( 'Top Viewed Documents', 'wud' ),
				'category_id' => '',
				'limit'       => 5,
			)
		);
        ...
        <p>
            ...
            <br/>
            <small><?php esc_html_e( 'Number of top viewed documents.', 'wud' ); ?></small>
        </p>
	...
	public function widget( $args, $instance ) {
		...
		$docs       = $docs_model->get_top_viewed_documents( $category_id, $limit );
		...
		<?php
		include wud_get_template( 'widgets/topviewed', false, false );
		?>
