    ...
    public function mycred_learndash_override_data($post) {
        ...
        <div class="custom-option">
            <label>
                ...
                <?php _e("Dont Allow using myCred points in buying this course?", "mycred"); ?>
            </label>
            <div class="option-wrapper">
                <div class="form-element two-cols">
                    <input type="checkbox" name="allow_buy_course_pts" value="1" <?php checked($allow, true); ?> /><?php echo __('Yes', 'mycred'); ?>     
                </div>
                <div class="help-text"><?php _e('dont allow users to enrolling in this course using their point(s) balance(s)', 'mycred'); ?></div>
            </div>
        </div>
