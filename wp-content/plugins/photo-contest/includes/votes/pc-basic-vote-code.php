                ...
                if ($is_image_active == 0) {
				    ...
				    $who_vote       = get_option('pcplugin-who-vote');
                     ...
                     if ($who_vote == 2 and $confirm_votes==1 and !is_user_logged_in()) {
						...
						$html .= '<div class="pc-image-info-box-button-btn photo_vote pc-show" style="background-color: #' . $button_color . '"   data-item="' . $photo_id . '" data-nonce="' .$nonce. '" data-share="' . $allow_redirect . '" data-option="basic">';
						$html .= '<div class="pc-image-info-box-button-btn-text">' . $icon . ' ' . $text . '</div>';
						$html .= '</div>';
