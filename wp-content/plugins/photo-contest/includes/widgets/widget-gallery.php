...
class mm_wp_photocontest_widget_gallery extends WP_Widget {
...
'mm_wp_photocontest_widget_gallery', 

// Widget name will appear in UI
__('Photo Contest Widget - Gallery', 'photo-contest'), 
...
if ( $attachments ) {
   ...
   if($photo_active!=0){
   $image_attributes = wp_get_attachment_image_src( $post->ID, 'photo-small' );
   global $wpdb;
