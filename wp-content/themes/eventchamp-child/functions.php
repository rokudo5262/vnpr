...
if( !function_exists( 'eventchamp_child_theme_setup' ) ) {
	...
	function eventchamp_child_theme_setup() {
		...
		wp_enqueue_style( 'eventchamp-child-style', get_stylesheet_directory_uri() . '/style.css', array(), '1.0.1' );
    wp_enqueue_script( 'eventchamp-child-script', get_stylesheet_directory_uri() . '/custom.js', array(), '1.0.1', true );
